...
//Chaging image depending upon dice number
    ...
    //1.1 For Player 1
if(randomNo1 == 1){
    document.getElementsByClassName("img1")[0].src = "Images/stone.png";
}
else if(randomNo1 == 2){
    document.getElementsByClassName("img1")[0].src = "Images/paper.png";
}
else if(randomNo1 == 3){
    document.getElementsByClassName("img1")[0].src = "Images/sessior.png";
}

    //For Player 2
if(randomNo2 == 1){
    document.getElementsByClassName("img2")[0].src = "Images/stone.png";
}
else if(randomNo2 == 2){
    document.getElementsByClassName("img2")[0].src = "Images/paper.png";
}
else if(randomNo2 == 3){
    document.getElementsByClassName("img2")[0].src = "Images/sessior.png";
}
